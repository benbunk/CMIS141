 ...
 *   (first, last, middle names, age in years, and 3 lucky numbers) and will
 *   display personalized welcome messages and calculate a lucky average from
 *   the lucky numbers.
 */

package edu.umuc.cmis141.project1;
...
public final class BenjaminBunkp1 
{
    ...
    public static void main(final String[] args )
    {
        ...
        userMiddle = JOptionPane.showInputDialog("What is your middle name?");
